...
Generated by [`reference/compare_models.py`](reference/compare_models.py); the
order and message metrics mirror the dashboard, while N_eff and dropped-turns are
